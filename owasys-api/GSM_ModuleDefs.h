 ...
 * @warning In 4G networks it is mandatory to have the PDP activated
 *        to register successfully to the network. 
 *         Use function @ref GSM_DefinePDPContext() right after
 *        starting GSM using the SIM card user, password and APN values.
 * @return NO_ERROR if success. Specific error number if fails.
 */
   int GSM_Start( void);
 ...
 *
 * @return NO_ERROR if success. Specific error number if fails.
 * @deprecated From the libGSM 1.1.1+ it does not have any effect. It will be removed in future versions
 */
__attribute__ ((__deprecated__ ("From the libGSM 1.1.1+ it does not have any effect. It will be removed in future versions")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * @deprecated Use @ref GSM_GetServingCell function instead to get the signal strength 
 * on the level parameter to support all of the radio technologies.
 */
__attribute__ ((__deprecated__ ("Use GSM_GetServingCell function instead to get the signal strength on the level parameter to support all of the radio technologies.")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_GetServingCell function instead to get the signal quality (q parameter)
 */
__attribute__ ((__deprecated__ ("Use GSM_GetServingCell function instead to get the signal quality (q parameter)")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_GetServingCell function instead to get the cell information
 */
__attribute__ ((__deprecated__ ("Use GSM_GetServingCell function instead to get the cell information")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * @deprecated Not supported for the owa344. It will be removed in future versions 
 */
__attribute__ ((__deprecated__ ("It will be removed in future versions.")))
 ...
 *    4: SMS_ALL
 * @return NO_ERROR if success. Specific error number if fails.
 * @deprecated Use @ref GSM_ReadSMSExtended function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_ReadSMSExtended function instead")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_DeleteSMSExtended function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_DeleteSMSExtended function instead")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_SendSMSExtended function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_SendSMSExtended function instead")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_SendSMSExtendedBySize function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_SendSMSExtendedBySize function instead")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_WriteSMSToMemoryExtended function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_WriteSMSToMemoryExtended function instead")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_ReadPDUSMSExtended function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_ReadPDUSMSExtended function instead")))
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_WritePDUSMSToMemoryExtended function instead
 */
__attribute__ ((__deprecated__ ("Use GSM_WritePDUSMSToMemoryExtended function instead")))
...
/**
 * @brief This function will get the EID from the SIM card
 *
 * @param *wEid String which returns the EID of the SIM card.
 * @param wSize Size of the wEid variable
 * @return NO_ERROR if success. Specific error number if fails.
 */
   int GSM_GetEID( char* wEid, int wSize);

/**
 * @brief Get the audio model
 *
 * @return Audio model. Should be 4 (CINTERION) or 5 (QUECTEL)
 */
 ...
 * @return NO_ERROR if success. Specific error number if fails.
 * 
 * @deprecated Use @ref GSM_GetServingCell() to get the cell information
 */
__attribute__ ((__deprecated__ ("Use GSM_GetServingCell() to get the cell information")))
 ...
 * @deprecated Use @ref GSM_GetServingCell() to get the cell information
 */
__attribute__ ((__deprecated__ ("Use GSM_GetServingCell() to get the cell and radio technology information")))
...
/**
 * @brief Set PLS63-W mode
 *
 * @param wMode Mode
 *    0: Voice centric
 *    1: Data centric
 * @param *wChange Value not modified or GSM_ERR_REINIT_REQUIRED
 * @return NO_ERROR if success. Specific error number if fails.
 */
   int GSM_SetDataCentric( int wMode, int *wChange);

/**
 * @brief Gets the extended error of the last failed operation
 * 
 * @param *location: location id cause
 * @param *code: cause
 *
 * @return NO_ERROR if success. Specific error number if fails.
 */
   int GSM_GetExtendedErrorReport( int *location, int *code);

/**
 * @brief Gets the serving cell data and signal quality
 * 
 * @param *q: Quality estimation (0...5) according to the quality of received signal and the rat
 * @param *ind: Quality estimation given by the module manufacturer (not available on the owa450)
 * @param *level: received signal strength in dBm. (based on 2G: rssi, 3G: rscp, LTE: rsrp)
 * @param *wCellAndRAT: Cell id, LAC/TAC and rat of the serving cell
 * @param *plmn: Network id of the serving cell (Public Land Mobile Network)
 *
 * @return NO_ERROR if success. Specific error number if fails.
 */
   int GSM_GetServingCell( u_int8_t *q, u_int8_t *ind, int *level, GSM_CellAndRAT_t* wCellAndRAT, u_int32_t *plmn);
